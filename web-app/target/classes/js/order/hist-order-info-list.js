...
$("#export").click(function () {
    ...
    $.ajax({
        type: "POST",
        data: orderInfoVo,
        url: "/deal-manage/hist-order/export",
        dataType: "json",
        success: function (data) {
            ...
            if (data.code == 1) {
                ...
                var loadUrl = "/deal-manage/hist-order/down-excel-data?tempName=" + tempName + '&fileName=' + fileName;
 ...
 */
function down() {
    var fileName = "hist-order-info.xlsx";
    var loadUrl = "/deal-manage/hist-order/down?fileName=终端批量导入-模板.xlsx&realFileAddr=" + fileName;
    window.location.href = loadUrl;
}
