var tranVo = new Object();

function setSearchParam() {
    tranVo.mid = $("#mid").val();
    tranVo.subMid = $("#subMid").val();
    tranVo.tid = $("#tid").val();
    tranVo.txnId = $("#txnId").val();
    tranVo.sysOrderId = $("#sysOrderId").val();
    tranVo.orderId = $("#orderId").val();
    tranVo.trace = $("#trace").val();
    tranVo.txnStatus = $("#txnStatus").val();
    tranVo.channels = $("#channels").val();
    tranVo.payType = $("#payType").val();
    tranVo.settleStatus = $("#settleStatus").val();
    tranVo.tranStatus = $("#tranStatus").val();
    tranVo.goods = $("#goods").val();
    tranVo.payTimeBegin = $("#payTimeBegin").val();
    tranVo.payTimeEnd = $("#payTimeEnd").val();
    tranVo.settleTimeBegin = $("#settleTimeBegin").val();
    tranVo.settleTimeEnd = $("#settleTimeEnd").val();
    tranVo.uploadDateBegin = $("#uploadDateBegin").val();
    tranVo.uploadDateEnd = $("#uploadDateEnd").val();
    tranVo.txnTimeBegin = $("#txnTimeBegin").val();
    tranVo.txnTimeEnd = $("#txnTimeEnd").val();
}

jQuery(document).ready(function () {
    setSearchParam();

    $("#uploadDateBegin").datetimepicker({
        language: 'zh-CN',
        timePicker: false,
        minView: "month",
        format: "yyyy-mm-dd",
        ...
        $("#uploadDateEnd").datetimepicker("setStartDate", $("#uploadDateBegin").val());
        $("#uploadDateBegin").datetimepicker("hide");
    });
    $("#uploadDateEnd").datetimepicker({
        language: 'zh-CN',
        timePicker: false,
        minView: "month",
        format: "yyyy-mm-dd",
        ...
        $("#uploadDateBegin").datetimepicker("setEndDate", $("#uploadDateEnd").val());
        $("#uploadDateEnd").datetimepicker("hide");
    });
    ...
    $("#uploadDateBeginClear").click(function () {
        $("#uploadDateBegin").val("");
    });

    $("#uploadDateEndClear").click(function () {
        $("#uploadDateEnd").val("");
    });
});
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.code == 1) {
                ...
                var loadUrl = "/trans/hist-trans/down-excel-data?tempName=" + tempName + '&fileName=' + fileName;
 ...
 */
function down() {
    var fileName = "hist-trans.xlsx";
    var loadUrl = "/trans/hist-trans/down?fileName=终端批量导入-模板.xlsx&realFileAddr=" + fileName;
    window.location.href = loadUrl;
}
