$(function () {
    ...
    $("#btnSave").click(function () {
        ...
        if (issuId == null || issuId == ""||issuId=="请选择发卡机构代码") {
            ...
            return false;
        } else if (flag == null || flag == ""||flag=="请选择激活标记") {
            BootboxExt.alert("请选择激活标记");
            return false;
            ...
            Shade.blockUI($("#onlineInstAcceptBody"));
            $.post("/accept-manage/online-inst-accept/online-inst-accept-add", {
                "issuId": issuId,
                "issuName": issuName,
                "acqId": acqId,
                "acqName": acqName,
                ...
                Shade.unblockUI($("#onlineInstAcceptBody"));
                if (data.result == true) {
                    BootboxExt.alert(data.msg, function () {
                        location.href = "/accept-manage/online-inst-accept/online-inst-accept-search";
                    });
                } else {
                    BootboxExt.alert(data.msg, function () {
    ...
    $("#btnUpdate").click(function () {
        ...
        if (getStrLength(issuName) > 60) {
            ...
            Shade.blockUI($("#onlineInstAcceptBody"));
            $.post("/accept-manage/online-inst-accept/online-inst-accept-update", {
                "issuId": issuId,
                "issuName": issuName,
                "acqId": acqId,
                "acqName": acqName,
...
function onlineInstAcceptDel(issuId, acqId) {
    BootboxExt.confirm("确认删除吗？", function (res) {
        if (res) {
            $.get("/accept-manage/online-inst-accept/online-inst-accept-delete", {
                "issuId": issuId,
                "acqId": acqId
            }, function (data) {
                if (data.result == true) {
