    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.code == 1) {
                ...
                var loadUrl = "/trans/pos-trans/down-excel-data?tempName=" + tempName + '&fileName=' + fileName;
 ...
 */
function down() {
    var fileName = "pos-trans.xlsx";
    var loadUrl = "/trans/pos-trans/down?fileName=终端批量导入-模板.xlsx&realFileAddr=" + fileName;
    window.location.href = loadUrl;
}
